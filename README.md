...
```
<img src="/screenshots/compass1.png" alt="Capture1" width="200"/>
...
<img src="/screenshots/compass2.png" alt="Capture1" width="200"/>
...
<img src="/screenshots/mongoshell1.png" alt="Capture1" width="200"/>
...
use tugas2
```
<img src="/screenshots/mongoshell2.png" alt="Capture1" width="200"/>
5. Masukkan command berikut
```
db.internets.find().pretty()
```
6. Maka isi data akan ditampilkan pada shell
<img src="/screenshots/mongoshell3.png" alt="Capture1" width="200"/>
...
```
3. Gunakan API yang sudah tersedia pada postman collection, untuk lebih jelasnya dapat dilihat pada demo video
Link : https://www.youtube.com/watch?v=dL2ZhtTaLK0
